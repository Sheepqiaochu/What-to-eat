            ...
            public void onClick(View v) {
                ...
                */
                ...
                if(permit) {
                    ...
                    Intent intent = new Intent(Login.this, ClientActivity.class);
                    intent.putExtra("user", MyApplication.user);   //传参
                    startActivity(intent);
                    return;
                }
                else
...
/*
    ...
    private void parseJSONWithJSON(String jsonData){    //用json处理json数据
        try{
            ...
            //auser=new User();
            MyApplication.user.setPhoneNumber(jsonObject.getString("phoneNumber"));
            MyApplication.user.setPassword(jsonObject.getString("password"));
            MyApplication.user.setName(jsonObject.getString("name"));
            MyApplication.user.setUid(jsonObject.getInt("uid"));
