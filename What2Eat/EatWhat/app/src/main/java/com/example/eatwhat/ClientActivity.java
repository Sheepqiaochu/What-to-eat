...
public class ClientActivity extends AppCompatActivity {
    ...
    static public User user; //这个变量user要传参传过来
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MyApplication.user.getUid()!=-1) {
            ...
            usernameText.setText(MyApplication.user.getName());
            TextView phoneText = (TextView) findViewById(R.id.text_phone);   //显示用户昵称、手机号
            //phoneText.setText("69779110");
            phoneText.setText(MyApplication.user.getPhoneNumber());
            //**********************************
            /*
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(function.getName()=="我的评价")
                {
                    if(MyApplication.user.getUid()!=-1) {
                        ...
                        Toast.makeText(ClientActivity.this, "请先登录", Toast.LENGTH_SHORT).show();
                }
                //*************************************************
                ...
                if(function.getName()=="我的收藏")
                {

                    if(MyApplication.user.getUid()!=-1) {
                        Intent intent = new Intent(ClientActivity.this, ClientStars.class);
